  ...
  spec.heading('TGI SPEC', function () {
    ...
    spec.heading('METHODS', function () {
      ...
      spec.heading('mute(true/false)', function () {
        spec.paragraph('Tests can be muted and unmuted.  All documentation will be muted but tests will be run.  Return value is object with stats of run tests.');
        ...
        spec.paragraph('with muted tests...');
